...
{
    public class AccountLinkingApprovalAuthorizationHandler
                    : AuthorizationHandler<AccountLinkingApproverRequirement, User>
    {
        ...
        public AccountLinkingApprovalAuthorizationHandler(IPermissionRepository permissionRepository,IRolePermissionRepository rolepermissionRepository, UserManager<User> _userManager)
        {
        ...
        protected override  Task HandleRequirementAsync(
                                   ...
                                   AccountLinkingApproverRequirement requirement,
                                     User resource)
        {
            ...
            var name = "ApproveAccountLinking";
    ...
    public class AccountLinkingApproverRequirement : IAuthorizationRequirement { }
}
