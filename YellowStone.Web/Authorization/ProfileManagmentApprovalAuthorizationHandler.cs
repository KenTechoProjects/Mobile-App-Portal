...
{
    public class ProfileManagmentApprovalAuthorizationHandler
                    : AuthorizationHandler<ApproveProfileManagementRequirement, User>
    {
        ...
        public ProfileManagmentApprovalAuthorizationHandler(IPermissionRepository permissionRepository,IRolePermissionRepository rolepermissionRepository, UserManager<User> _userManager)
        {
        ...
        protected override  Task HandleRequirementAsync(
                                   ...
                                   ApproveProfileManagementRequirement requirement,
                                     User resource)
        {
    ...
    public class ApproveProfileManagementRequirement : IAuthorizationRequirement { }
}
