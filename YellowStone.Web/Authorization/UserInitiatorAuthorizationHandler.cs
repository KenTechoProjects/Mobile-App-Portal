...
{
    public class UserInitiatorAuthorizationHandler
                    : AuthorizationHandler<UserInitiatorRequirement, User>
    {
       ...
       // private readonly IUserRepository userRepository;
        ...
        public UserInitiatorAuthorizationHandler(IPermissionRepository permissionRepository,IRolePermissionRepository rolepermissionRepository, UserManager<User> _userManager)
        {
        ...
        protected override  Task HandleRequirementAsync(
                                   ...
                                   UserInitiatorRequirement requirement,
                                     User resource)
        {
    ...
    public class UserInitiatorRequirement : IAuthorizationRequirement { }
}
