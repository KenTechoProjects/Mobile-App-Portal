...
{
    public class RoleInitiatorAuthorizationHandler
                    : AuthorizationHandler<RoleInitiatorRequirement, User>
    {
        ...
        public RoleInitiatorAuthorizationHandler(IPermissionRepository permissionRepository,IRolePermissionRepository rolepermissionRepository, UserManager<User> _userManager)
        {
        ...
        protected override  Task HandleRequirementAsync(AuthorizationHandlerContext context, RoleInitiatorRequirement requirement,User resource)
        {
    ...
    public class RoleInitiatorRequirement : IAuthorizationRequirement { }
}
