...
{
    public class DepartmentApprovalAuthorizationHandler
                    : AuthorizationHandler<DepartmentApprovalRequirement, User>
    {
       ...
       // private readonly IUserRepository userRepository;
        ...
        public DepartmentApprovalAuthorizationHandler(IPermissionRepository permissionRepository,IRolePermissionRepository rolepermissionRepository, UserManager<User> _userManager)
        {
        ...
        protected override  Task HandleRequirementAsync(
                                   ...
                                   DepartmentApprovalRequirement requirement,
                                     User resource)
        {
    ...
    public class DepartmentApprovalRequirement : IAuthorizationRequirement { }
}
