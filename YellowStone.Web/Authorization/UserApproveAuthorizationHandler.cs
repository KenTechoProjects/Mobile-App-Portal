...
{
    public class UserApproveAuthorizationHandler
                    : AuthorizationHandler<ApproveUsersRequirement, User>
    {
     ...
     //   private readonly IUserRepository userRepository;
        ...
        public UserApproveAuthorizationHandler(IPermissionRepository permissionRepository,IRolePermissionRepository rolepermissionRepository, UserManager<User> _userManager)
        {
        ...
        protected override  Task HandleRequirementAsync(
                                   ...
                                   ApproveUsersRequirement requirement,
                                     User resource)
        {
    ...
    public class ApproveUsersRequirement : IAuthorizationRequirement { }
}
