...
{
    public class RoleApprovalAuthorizationHandler
                    : AuthorizationHandler<RoleApprovalRequirement, User>
    {
        ...
        public RoleApprovalAuthorizationHandler(IPermissionRepository permissionRepository,IRolePermissionRepository rolepermissionRepository, UserManager<User> _userManager)
        {
        ...
        protected override  Task HandleRequirementAsync(
                                   ...
                                   RoleApprovalRequirement requirement,
                                     User resource)
        {
    ...
    public class RoleApprovalRequirement : IAuthorizationRequirement { }
}
