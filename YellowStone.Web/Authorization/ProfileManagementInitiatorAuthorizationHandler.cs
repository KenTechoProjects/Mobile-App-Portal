...
{
    public class ProfileManagementInitiatorAuthorizationHandler
                    : AuthorizationHandler<InitiateProfileManagementRequirement, User>
    {
        ...
        public ProfileManagementInitiatorAuthorizationHandler(IPermissionRepository permissionRepository,IRolePermissionRepository rolepermissionRepository, UserManager<User> _userManager)
        {
        ...
        protected override  Task HandleRequirementAsync(
                                   ...
                                   InitiateProfileManagementRequirement requirement,
                                     User resource)
        {
    ...
    public class InitiateProfileManagementRequirement : IAuthorizationRequirement { }
}
