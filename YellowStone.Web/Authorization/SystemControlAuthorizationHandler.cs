...
{
    public class SystemControlAuthorizationHandler
                    : AuthorizationHandler<SystemControlRequirement, User>
    {
      ...
      //  private readonly IUserRepository userRepository;
        ...
        public SystemControlAuthorizationHandler(IPermissionRepository permissionRepository,IRolePermissionRepository rolepermissionRepository, UserManager<User> _userManager)
        {
        ...
        protected override  Task HandleRequirementAsync(AuthorizationHandlerContext context, SystemControlRequirement requirement, User resource)
        {
    ...
    public class SystemControlRequirement : IAuthorizationRequirement { }
}
