...
{
    public class DepartmentInitiatorAuthorizationHandler
                    : AuthorizationHandler<DepartmentInitiatorRequirement, User>
    {
        ...
        public DepartmentInitiatorAuthorizationHandler(IPermissionRepository permissionRepository,IRolePermissionRepository rolepermissionRepository, UserManager<User> _userManager)
        {
        ...
        protected override  Task HandleRequirementAsync(
                                   ...
                                   DepartmentInitiatorRequirement requirement,
                                     User resource)
        {
    ...
    public class DepartmentInitiatorRequirement : IAuthorizationRequirement { }
}
