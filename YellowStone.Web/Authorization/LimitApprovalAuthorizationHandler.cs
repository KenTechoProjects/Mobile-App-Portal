...
{
    public class LimitApprovalAuthorizationHandler
                    : AuthorizationHandler<ApproveLimitRequirement, User>
    {
        ...
        public LimitApprovalAuthorizationHandler(IPermissionRepository permissionRepository,IRolePermissionRepository rolepermissionRepository, UserManager<User> _userManager)
        {
        ...
        protected override  Task HandleRequirementAsync(
                                   ...
                                   ApproveLimitRequirement requirement,
                                     User resource)
        {
    ...
    public class ApproveLimitRequirement : IAuthorizationRequirement { }
}
