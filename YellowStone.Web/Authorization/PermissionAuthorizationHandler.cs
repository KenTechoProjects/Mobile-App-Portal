...
namespace YellowStone.Authorization
{
                    ...
                    : AuthorizationHandler<OperationAuthorizationRequirement, User>
    {
        ...
        public PermissionAuthorizationHandler(IPermissionRepository permissionRepository,IRolePermissionRepository rolepermissionRepository, UserManager<User> _userManager)
        {
