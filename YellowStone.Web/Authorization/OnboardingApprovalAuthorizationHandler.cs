...
{
    public class OnboardingApprovalAuthorizationHandler
                    : AuthorizationHandler<ApproveOnboardingRequirement, User>
    {
        ...
        public OnboardingApprovalAuthorizationHandler(IPermissionRepository permissionRepository,IRolePermissionRepository rolepermissionRepository, UserManager<User> _userManager)
        {
        ...
        protected override  Task HandleRequirementAsync(
                                   ...
                                   ApproveOnboardingRequirement requirement,
                                     User resource)
        {
    ...
    public class ApproveOnboardingRequirement : IAuthorizationRequirement { }
}
