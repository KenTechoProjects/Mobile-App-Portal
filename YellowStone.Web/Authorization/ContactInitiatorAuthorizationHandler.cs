...
{
    public class ContactInitiatorAuthorizationHandler
                    : AuthorizationHandler<ContactInitiatorRequirement, User>
    {
        ...
        public ContactInitiatorAuthorizationHandler(IPermissionRepository permissionRepository,IRolePermissionRepository rolepermissionRepository, UserManager<User> _userManager)
        {
        ...
        protected override  Task HandleRequirementAsync(
                                   ...
                                   ContactInitiatorRequirement requirement,
                                     User resource)
        {
    ...
    public class ContactInitiatorRequirement : IAuthorizationRequirement { }
}
